...
public class DifferentialDrive extends RobotDriveBase implements Sendable, AutoCloseable {
  ...
  public DifferentialDrive(MotorController leftMotor, MotorController rightMotor) {
    ...
    SendableRegistry.addChild(this, this.leftMotor);
    SendableRegistry.addChild(this, this.rightMotor);
    instances++;
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
    ...
    leftMotor.set(speeds.left * m_maxOutput * 0.25);
    rightMotor.set(-speeds.right * m_maxOutput * 0.25);
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean allowTurnInPlace) {
    ...
    leftMotor.set(speeds.left * m_maxOutput);
    rightMotor.set(-speeds.right * m_maxOutput);
