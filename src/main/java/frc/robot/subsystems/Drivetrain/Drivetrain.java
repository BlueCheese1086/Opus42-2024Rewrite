...
public class Drivetrain extends SubsystemBase {
    // Motor config
    private final CANSparkMax frontLeftMotor = new CANSparkMax(RobotMap.FrontLeftID, MotorType.kBrushless);
    private final CANSparkMax frontRightMotor = new CANSparkMax(RobotMap.FrontRightID, MotorType.kBrushless);
    private final CANSparkMax backLeftMotor = new CANSparkMax(RobotMap.BackLeftID, MotorType.kBrushless);
    private final CANSparkMax backRightMotor = new CANSparkMax(RobotMap.BackRightID, MotorType.kBrushless);
